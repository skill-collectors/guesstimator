...
<TgParagraph>
  ...
  room may have been deleted if it hasn't been used in a while. You can always
  <TgLink href="/rooms">create a new room.</TgLink>
  If you're sure the room should exist, you can also
  <TgLink
