...
<div class="text-center">
	...
	<TgParagraph>This is an app for "pointing" agile stories. To get started</TgParagraph>
	{#if isApiAvailable}
		<TgButton id="createRoomButton" type="primary" href="/rooms" class="mt-4">Create a room</TgButton>
	{:else}
		<TgParagraph class="font-bold text-orange-800">
			The Guesstimator is currently unavailable, probably due to higher than expected demand. Please try again
			later, or if the problem persists for more than a day you can
			<TgLink
